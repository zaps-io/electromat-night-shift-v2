...
6. **How to pay (QA repro — this PR, not live Pages on `main`):**
   ...
   4. Payment is not gated on a full battery. Then **E AUTOCHARGE**. Later queue cars: talk → park → plug → same pay.
