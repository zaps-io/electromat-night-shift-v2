 ...
 */
export const LEFT_CANOPY_X = -9.9;
export const RIGHT_CANOPY_X = 11.8;
...
export const KIOSK = { x: -22.6, z: -3.55 };

export const PAVILION = { x: -22.8, z: 3.4, yaw: 0, w: 11.6, d: 13.4, h: 3.35 };
...
export const YARD = { x: 18.8, z: 17.0, w: 10.4, d: 6.2 };
