...
export function nightRoster(): Guest[] {
  ...
  return [
    ...
    guest("ruiz", "Ruiz", "NS-441", "auto", "AutoCharge. Full power.", base + 2, 20, 0x1a2230, 38, "suv"),
    guest("peck", "Peck", "PHX-88", "kiosk", "First visit. Plug, then the kiosk.", base + 4, 22, 0x2a2c32, 28, "sedan"),
    ...
    guest("kim", "Kim", "AMB-3", "kiosk", "Night shift. Need a stall.", base + 110, 22, 0x14161c, 30, "suv"),
  ];
}
